...
**Testing Patterns**: For KCL testing patterns (XR inline definitions, test naming, timeouts, conditional resources, resource counts, tag propagation), see [TESTING_REFERENCE.md → KCL Testing Patterns](TESTING_REFERENCE.md#kcl-testing-patterns).
