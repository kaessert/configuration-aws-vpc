# Upbound Console Monitoring Guide
...
**Console URL**: https://console.upbound.io
...
- [Monitoring E2E Test Progress](#monitoring-e2e-test-progress)
- [Package Installation](#monitoring-package-installation)
- [Resource Creation](#monitoring-resource-creation)
- [Events](#monitoring-events)
- [Composite Resources](#monitoring-composite-resources-xr)
- [Provider Configuration](#checking-aws-provider-configuration)
- [Troubleshooting](#console-troubleshooting)
- [Status Colors](#quick-reference-status-colors)
- [Success Criteria](#what-success-looks-like)
- [Pro Tips](#console-pro-tips)
...
Replace `<control-plane-id>` with actual control plane name:
...
If you prefer CLI over web console:
...
**Note**: E2E tests run in ephemeral control planes, so direct kubectl access requires connecting to the control plane context first.

---

## Related Documentation

- **up CLI Commands**: [UPBOUND_REFERENCE.md](UPBOUND_REFERENCE.md) - Complete CLI reference
- **Testing Reference**: [TESTING_REFERENCE.md](TESTING_REFERENCE.md) - Test schemas and patterns
- **TDD Strategy**: [TDD_STRATEGY.md](TDD_STRATEGY.md) - Testing workflow
