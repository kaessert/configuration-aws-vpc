...
A comprehensive reference guide for the Upbound CLI (`up`) and Upbound Cloud platform management, covering authentication, project workflows, control plane management, and cloud resource hierarchy.

## Table of Contents

- [Part 1: Platform Architecture](#part-1-platform-architecture)
- [Part 2: Authentication & Setup (CRITICAL)](#part-2-authentication--setup-critical)
- [Part 3: Project Management](#part-3-project-management)
- [Part 4: Group Management](#part-4-group-management)
- [Part 5: Control Plane Management](#part-5-control-plane-management)
- [Part 6: Context Management](#part-6-context-management)
- [Part 7: Common Workflows](#part-7-common-workflows)
- [Part 8: Safety & Best Practices](#part-8-safety--best-practices)
- [Part 9: Debugging & Troubleshooting](#part-9-debugging--troubleshooting)
...
## Part 2: Authentication & Setup (CRITICAL)
...
For web console usage, see: [upbound-console.md](./upbound-console.md)

---

**Note**: This guide consolidates information from multiple sources and is based on up CLI v0.42.0. Commands and options may vary in different versions. Always check `up --help` for the most current information.
